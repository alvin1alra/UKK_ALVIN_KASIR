...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html">KASIR ADMIN</a>
            </div>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Produk {{ $data->NamaProduk }}</h3>
            </div>
        </div>
    </div>
...
<div class="container">
    <h1>Edit Produk {{ $data->NamaProduk }}</h1>

    <form action="update-produk/{{ $data->ProdukID }}" method="POST">
        @csrf
        <label class="form-label" for="">Nama Produk</label>
        
        <input class="form-control" type="text" name="NamaProduk" value="{{ $data->NamaProduk }}">
